...
sudo pip3 install -U numpy==1.16.1 future==0.17.1 mock==3.0.5 h5py==2.9.0 keras_preprocessing==1.1.0 keras_applications==1.0.8 gast==0.2.2 futures protobuf pybind11
