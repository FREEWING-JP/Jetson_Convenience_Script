...
sudo pip3 install -U future==0.18.2 mock==3.0.5 h5py==$H5PY_VER keras_preprocessing==1.1.2 keras_applications==1.0.8 gast==$GAST_VER futures==3.1.1 pybind11==2.6.2
